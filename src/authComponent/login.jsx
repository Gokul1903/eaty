                ...
                <div className="row justify-content-center">
                  <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                      ...
                      <p className="text-center text-white mt-4">Create account?<Link className="login ml-1"  to={"/"}>Sign up</Link>|<Link className="login ml-1"  to={"/Forgot"}>Forgot password</Link></p>
                    </form>
                  </div>
